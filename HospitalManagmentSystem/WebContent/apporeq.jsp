...
<head>
    ...
    <title>patient requests for appo</title>
...
<%
String name=null,dob=null,sex=null,email=null,address=null,contact=null,doctorid=null,doctorname=null,appdate=null,apptime=null,remarks=null;
Connection con=null;
try
{
	...
	String str1="select distinct email from appoinmentreq ";
	ResultSet rs1=st.executeQuery(str1);
	if(rs1.next())
	{}
	String str="select * from appoinmentreq group by email";
	...
	session1.setAttribute("emailpatien", email);
...
<td><a href="apporeq1.jsp?email=<%=email %>"><input type="submit" name="remarks" size="20" value="take an appointment"></a></td>
</tr>
		<% 
		
	}
	System.out.println("malayalam"+email);
}
catch(Exception e)
{
