...
<%
String name=null,dob=null,sex=null,address=null,contact=null,doctorid=null,doctorname=null,appdate=null,apptime=null,remarks=null;

String email=(String)session.getAttribute("emailpatien");
...
try
{
	...
	while(rs.next())
	{
		...
		session1.setAttribute("emailpatie",email );
	}
}
catch(Exception e)
{
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<form role="form" class="lead"action="apporeq2.jsp" >
										<div class="row">
										...
										<input type="submit"name="take" value="Take an appointment" class="btn btn-skin btn-block btn-lg">
										</form>
										</div>
