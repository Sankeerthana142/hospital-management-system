...
System.out.println(email);
 str2=request.getParameter("availday");
System.out.println(str2);
 str3=request.getParameter("availtime");
...
try {
	...
	if(rs.next())
	{
			...
			String str4="update doctor set availday='"+str2+"',availtime='"+str3+"' where email='"+email+"'";
			System.out.println(str4);
			int result=st.executeUpdate(str4);
			if(result>0)
			{ 
				System.out.println("successfully updated date and time");
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>Availability<small></small></h3>
									</div>
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="availday"  class="form-control input-md">
												</div>
											</div>
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="time" name="availtime" class="form-control input-md">
												</div>
											</div>
