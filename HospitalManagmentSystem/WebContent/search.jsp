					...
					<div class="col-lg-20">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<tr>
<th><b>Name</b></th>
<th><b>Specialization</b>
<th><b>Contact</b></th>
<th><b>email</b></th>
<!-- <th><b>view</b></th> -->
</tr>
<%
String name=null,specialization=null,contact=null,email=null;
Connection con=null;
try
{
	String special=(String)request.getParameter("specialization");
	
	Class.forName("com.mysql.jdbc.Driver");
	con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital","root","");
	Statement st=con.createStatement();
	String str="select * from doctor where specialization like '"+special+"'or name like '"+special+"'";
...
<td> <input type="text" name="dob" size="20" value="<%=specialization %>"disabled></td>
<td><input type="text" name="doctorname"size="15" value="<%= contact%>"disabled></td>
<td><input type="text" name="email"size="20" value="<%=email %>"disabled></td>
<td><a href="dview.jsp?email=<%=email %>"><button>view</button></a></td>
