...
<div id="wrapper">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  ...
			  <li class="active"><a href="receptreg.jsp"><b>Add a receptionist</b></a></li>
			...
			<div class="container">
				<div class="row">
					...
					<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
							...
							<div class="button"><br><i class="fa fa-user fa-3x circled bg-skin"></i></div>
							<h4 class="h-bold">Receptionist</h4>
						</div>
					...
					<div class="col-lg-7">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Receptionist<small></small></h3>
									</div>
									<div class="panel-body">
									
									<table width="300">
									<form action="searchrecep.jsp" method="post">
...
<%
String name=null,contact=null,email=null;
Connection con=null;
try
{
	...
	String str="select * from receptionist";
	...
	while(rs.next())
	{
		...
		session1.setAttribute("emailrecep", email); 
...
<td><a href="rview.jsp?email=<%=email %>"><button>view</button></a></td>
