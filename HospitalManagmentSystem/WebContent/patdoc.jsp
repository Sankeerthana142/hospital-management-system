					...
					<div class="col-lg-10">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<tr>
									<div>
									<form action="patsearchdoc.jsp" method="post">
...
try
{
	...
	while(rs.next())
	{
		...
		%>
		<tr>
<td> <input type="text" name="doctorname" size="20" value="<%=name %>"disabled></td>

<td><input type="text" name="specialization"size="15" value="<%= specialization%>"disabled></td>
