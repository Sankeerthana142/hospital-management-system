...
<%
String name=null,dob=null,jod=null,sex=null,address=null,contact=null,specialization=null,image=null;
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  ...
			  <li class="active"><a href="resetpassdoctor.jsp">Reset password</a></li>
				<li><a href="avail.jsp">availability</a></li>
				<li><a href="appointments.jsp?email1=<%=email%>">appointments</a></li>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Doctor Account<small></small></h3>
									</div>
