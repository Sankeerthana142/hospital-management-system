					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span><small></small></h3>
									</div>
									<div class="panel-body">
									<form role="form" class="lead" action ="patientmail1.jsp">
										<div class="row">
										...
										<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<input type="submit"name="send" value="send"class="btn btn-skin btn-block btn-lg">
