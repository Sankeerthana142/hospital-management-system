...
email=(String)session.getAttribute("emailpp");

name=request.getParameter("name");
System.out.println("my name was"+name);
dob=request.getParameter("dob");
sex=request.getParameter("sex");
address=request.getParameter("address");
System.out.println("my addres was"+address);
...
try
{
	...
	String str1="update patient set  name='"+name+"',dob='"+dob+"',sex='"+sex+"',address='"+address+"',contact='"+contact+"',remarks='"+remarks+"' where email='"+email+"'";
									...
									<form role="form" class="lead" >
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Remarks</label>
													<input type="textarea" rows="5" cols="10" name="remarks" value="<%=remarks%>" class="form-control input-md"disabled>
												</div>
											</div>
											<a href="pdelete.jsp?emaildoc=<%=email %>"><input type="button"name="delete" value="delete" class="btn btn-skin btn-block btn-lg"></a>
										
										<a href="pupdate.jsp?emaildoc=<%=email%>"><input type="button"name="update" value="update" class="btn btn-skin btn-block btn-lg"></a>
										</div>
