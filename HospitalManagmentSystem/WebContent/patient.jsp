...
System.out.println("kkaalluu"+email);
...
try
{
	...
	String str1="select * from appoinments where pemail='"+email+"'";
	...
	appdate=rs1.getString("appdate");
	apptime=rs1.getString("apptime");
	}
}
catch(Exception e)
{
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  ...
			  <li class="active"><a href="takeappo.jsp?emailpatient=<%= email %>">Take an appointment</a></li>
			  <li class="active"><a href="patdoc.jsp">Doctors</a></li>
			   <li class="active"><a href="resetpasspatient.jsp">Reset password</a></li>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Patient details<small></small></h3>
									</div>
										...
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="email" name="doctorid" value="<%=doctorid %>" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Doctor name</label>
													<input type="text" name="doctorname" value="<%=doctorname%>" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Appointment date</label>
													<input type="date" name="appdate"  value="<%=appdate%>"class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Appointment time</label>
													<input type="time" name="apptime"  value="<%=apptime%>"class="form-control input-md">
												</div>
											</div>
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Email</label>
													<input type="email" name="email" value="<%=email%>" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Remarks</label>
													<input type="textarea" rows="5" cols="10" name="remarks" value="<%=remarks%>" class="form-control input-md">
												</div>
											</div>
										</div>
