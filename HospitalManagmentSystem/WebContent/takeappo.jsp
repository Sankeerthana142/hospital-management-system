					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> Appointment details<small></small></h3>
									</div>
									<div class="panel-body">
									<form role="form" class="lead" action="takeappo1.jsp" >
										<div class="row">
											
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Doctor name</label>
													<input type="text" name="doctorname"  class="form-control input-md"required>
												</div>
											</div>
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Remarks</label>
													<input type="textarea" rows="5" cols="10" name="remarks" class="form-control input-md"required>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													
													<input type="submit" name="submit" value="take appointment"class="btn btn-skin btn-block btn-lg">
												</div>
												
											</div>
											</div>
											</form>
											<font color="red">*</font> your request will be processed in 12 hours.
										</div>
										</div>
