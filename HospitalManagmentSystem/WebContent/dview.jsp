...
<%
String name=null,dob=null,jod=null,sex=null,address=null,contact=null,email=null,specialization=null,availday=null,availtime=null,image=null;
		...
		<div class="intro-content">
			<div class="container">
						...
						<div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<div class="panel-body">
										...
										<div class="row">
										<form action = "doctorupdate.jsp?emaildoc=<%=email %>" method="post">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="specialization" value="<%=specialization%>" class="form-control input-md"disabled>
												</div>
											</div>
										 	<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="availday" value="<%=availday%>" class="form-control input-md"disabled>
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Available time</label>
													<input type="time" name="availtime" value="<%=availtime%>" class="form-control input-md"disabled>
												</div>
											</div>
				...
				<input type="submit"name="update" value="update" class="btn btn-skin btn-block btn-lg">
										...
										<a href="doctordelete.jsp?emaildoc=<%=email %>"><input type="button"name="delete" value="delete" onclick="{return confirmComplete();}"class="btn btn-skin btn-block btn-lg"></a>
