...
<%
String name=null,dob=null,jod=null,sex=null,address=null,contact=null,email=null,image=null;
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span>Reception view<small></small></h3>
									</div>
									<div class="panel-body">
									<form role="form" class="lead" action="receptupdate.jsp?emaildoc=<%=email%>">
										<div class="row">
										...
										<div>
										<a href="receptdelete.jsp?emailrecep=<%=email %>"><input type="button"name="delete" value="delete" class="btn btn-skin btn-block btn-lg"></a>
										</div>
