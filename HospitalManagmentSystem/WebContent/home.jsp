    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll">
                <div class="navbar-toggle" data-toggle="collapse" data-target=".navbar-main-collapse">
			...
			<div class="container">
				<div class="row">
					...
					<h4 class="h-light">Provide <span class="color">best quality healthcare</span> for you</h4>
						...
						<ul class="lead-list">
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>The leading tertiary care hospital in India</strong><br /> The best in its field owing to its remarkable panel of eminent doctors</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Choose your favourite doctor</strong><br />highly experienced, skilled and distinguished in their respective fields of expertise practitioners</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Only use friendly environment</strong><br />make a positive environment</span></li>
						</ul>
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> LOGIN <small></small></h3>
									</div>
									<div class="panel-body">
									<form role="form" class="lead" action="login1"method="post">
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>User name</label>
													<input type="email" name="user"  class="form-control input-md"required>
												</div>
											</div>
						...
						<div class="callaction bg-gray">
							<div class="row">
								<div class="col-md-8">
									...
									<p>The leading tertiary care hospital in India</p>
									</div>
									</div>
								</div>
								<div class="col-md-4">
