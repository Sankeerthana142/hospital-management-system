...
String email=(String)session.getAttribute("emaildoc");
System.out.println("my email was"+email);
...
jod=request.getParameter("jod");
specialization=request.getParameter("specialization");
availday=request.getParameter("availday");
availtime=request.getParameter("availtime");
...
try
{
	...
	Statement st=con.createStatement();
		...
		String str1="update doctor set  name='"+name+"',dob='"+dob+"',jod='"+jod+"',sex='"+sex+"',address='"+address+"',contact='"+contact+"',specialization='"+specialization+"' where email='"+email+"'";
	 	System.out.println(str1);
		int result=st.executeUpdate(str1);
		if(result>0)
		{
			System.out.println("successfully updated");
			RequestDispatcher rd=request.getRequestDispatcher("alldocadmin.jsp");
										...
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="text" name="availday" value="<%=availday%>" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Available time</label>
													<input type="time" name="availtime" value="<%=availtime%>" class="form-control input-md">
												</div>
											</div>
										</div>
