...
<%
String name=null,dob=null,jod=null,sex=null,address=null,contact=null;


String email=(String)session.getAttribute("emailrecep");
...
try
{
	...
	Statement st=con.createStatement();
		...
		String str1="update receptionist set  name='"+name+"',dob='"+dob+"',jod='"+jod+"',sex='"+sex+"',address='"+address+"',contact='"+contact+"' where email='"+email+"'";
	 	System.out.println(str1);
		int result=st.executeUpdate(str1);
		if(result>0)
		{
			System.out.println("successfully updated");
			RequestDispatcher rd=request.getRequestDispatcher("allrecepadmin.jsp");
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<form role="form" class="lead" action="receptupdate.jsp" >
										<div class="row">
