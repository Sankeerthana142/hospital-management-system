...
try {
	...
	String str="INSERT INTO receptionist(name,dob,jod,sex,address,contact,email,password,image)values('"+name+"','"+dob+"','"+jod+"','"+sex+"','"+address+"','"+contact+"','"+email+"','"+password+"','"+image+"')";
	System.out.println(str);
	int result=st.executeUpdate(str);
	if(result>0)
	{   
		String str2="receptionist";
